...
import com.example.SportyShoes.dao.Respository;
...
public class HomeController {
	...
	public String getAllUsers(ModelMap map) {
		map.addAttribute("useList",userRespository.getAllUsers());
		return "User";
	}
	
	@RequestMapping(value="searchUser",method=RequestMethod.GET)
	public String searchUser(@RequestParam("email")String email,ModelMap map) {
		map.addAttribute("userList",userRespository.searchUser(email));
		return "User";
	}
}
